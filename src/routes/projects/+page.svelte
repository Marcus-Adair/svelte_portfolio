...
<div class="flex flex-col gap-6">
	...
	<div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
		...
		{@render ProjectCard(
			...
			alpsPic,
			'I developed a Python CLI tool called ALPS (Automatic Least-Privilege Policy Suggestor) for graduate Software & Systems Security course. ALPS parses AWS infrastructure code, identifies insecure IAM policies, and suggests alternatives.'
		)}
		{@render ProjectCard(
			'Spatial Enrichment Data Engine (SEDE)',
			'https://drive.google.com/drive/folders/1p6R3zL03XLPOm3x2jNea5T9apxR6reDN?usp=sharing',
			sedePic,
			'I served as the front-end lead on a geocoding web application developed for my BS capstone project in collaboration with Idaho National Laboratory. The front-end was built with Angular/TypeScript.'
		)}
		{@render ProjectCard(
			...
			fqsPaperPic,
			'While serving as an undergraduate research assistant, I developed FDW, a high-throughput workflow utilizing Bash, Python, Singularity, and more. FDW significantly accelerated premier earthquake simulation software using the Open Science Grid.'
		)}
	</div>
</div>

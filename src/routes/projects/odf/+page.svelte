...
<div class="flex flex-col gap-6">
    ...
    <span>
        ...
        from previous work I did from 2022 to 2023; you can read about that in a published paper I authored <Link href="https://dl.acm.org/doi/10.1145/3624062.3624276">here</Link>.
    </span>

    <span>
        The UI was all built in Python using Plotly Dash. After this project I have gained much more experience in React and Svelte, and now I wish would not have used Python for the front-end (haha).
    ...
    <span>
        The project was much more that just a front-end. The goal turned out to be an enormous project that required a ton of engineering, development, and a year's worth of time.
        Thus, when the internship ended I continued to work on the project and I tied it into my work and research at the SCI Institute. Over that time, I built an entire automated workflow
        using AWS services (ECS Fargate, IAM Policies, Lambda Functions, etc.) that could be easily redeployed with my pipeline and infrastructure. 
    </span>
    ...
    <span>
        ...
        Theoretically I could have taken that code and deploy the workflow/resoources on other AWS account, but I never tried. I did take down the workflow and re-deploy it multiple times.
    </span>
